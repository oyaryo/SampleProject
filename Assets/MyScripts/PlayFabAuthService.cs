...
public class PlayFabAuthService
{
    ...
    public static string CustomUserId { get => PlayerPrefs.GetString(PLAYFAB_CUSTOM_ID, Guid.NewGuid().ToString()); }

    public void SaveCustomId()
    {
        PlayerPrefs.SetString(PLAYFAB_CUSTOM_ID, CustomUserId);
        PlayerPrefs.Save();
    }
}
